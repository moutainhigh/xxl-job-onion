...
public class EmailJobAlarm implements JobAlarm {
    ...
    public AlarmLevelAdjudicator.AlarmLevel[] handleLevel() {
        return new AlarmLevelAdjudicator.AlarmLevel[]{
                AlarmLevelAdjudicator.AlarmLevel.FIRST,
                AlarmLevelAdjudicator.AlarmLevel.SCOND};
    }
        ...
        if (info != null && info.getAlarmEmail() != null && info.getAlarmEmail().trim().length() > 0) {
            ...
            for (String email : emailSet) {
                ...
                try {
                    ...
                    helper.setTo(email);
                    helper.setSubject(AlarmerContent.getEnv() + title);
