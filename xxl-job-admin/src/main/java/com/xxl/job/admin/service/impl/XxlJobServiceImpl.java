...
public class XxlJobServiceImpl implements XxlJobService {
    ...
    public ReturnT<String> add(XxlJobInfo jobInfo) {
        ...
        // 如果运行模式为ONION
        if (GlueTypeEnum.ONION_BEAN == GlueTypeEnum.match(jobInfo.getGlueType())) {
            if (ExecutorBlockStrategyEnum.SERIAL_EXECUTION == ExecutorBlockStrategyEnum.match(jobInfo.getExecutorBlockStrategy(), null)) {
